  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      if (Modernizr.flexbox) {
        // Get data
        var gif_url = window.location.toString().match(/localhost/) && !window.location.toString().match(/\?live=1/) ? "http://localhost:5000/data.json?callback=JSON_CALLBACK" : "https://rugby-server.superhighfives.workers.dev/data.json?callback=JSON_CALLBACK";
